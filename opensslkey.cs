...
namespace folDigLib
{
	...
	class opensslkey
    {
		...
		//jlchs 04Ago2022 public static void Main(String[] args)
		//{
		...
		private static byte[] GetPkcs12(RSA rsa, String keycontainer, String cspprovider, uint KEYSPEC, uint cspflags)
		{
			...
			try
			{
				X509Certificate cert = new X509Certificate(hCertCntxt); //create certificate object from cert context.
																		//jlchs 04Ago2022  X509Certificate2UI.DisplayCertificate(new X509Certificate2(cert));  // display it, showing linked private key
